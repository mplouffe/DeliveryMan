...
namespace lvl_0
{
    public class MenuManager : MonoBehaviour
    {
        ...
        {
            m_inputActions.Menu.Enable();
            m_inputActions.Menu.Select.performed += OnSelectPerformed;
            m_inputActions.Menu.Escape.performed += OnEscapePerformed;
        ...
        private void Update()
        {
            if (!m_itemSelected)
            {
                ...
                {
                    var moveInput = m_inputActions.Menu.Move.ReadValue<Vector2>();
