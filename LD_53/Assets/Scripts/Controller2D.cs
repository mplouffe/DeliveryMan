...
public class Controller2D : RaycastController
{
    ...
    [SerializeField]
    private float maxDecendAngle;

    [SerializeField]
    private LayerMask ladderCollisionMask;
    ...
    public float FeetPosition
    {
        get
        {
            return transform.position.y - collider.bounds.extents.y;
        }
    }
    ...
    {
        base.Start();
        raycastResults = new RaycastHit2D[3];
    }
